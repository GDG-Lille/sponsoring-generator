...
const CONVENTION_FOLDER = "1aS4hF_19YRpp-SXM9Kgixj-Wj_vw1V26";
const INVOICE_FOLDER = "1aS4hF_19YRpp-SXM9Kgixj-Wj_vw1V26";
...
function getSponsoringFees(sponsoring) {
  switch (sponsoring) {
    case "bronze":
      return ["sept cents euros", 750, 2];
    case "silver":
      return ["mille cinq cents euros", 1500, 5];
    case "gold":
      return ["trois milles euros", 3000, 8];
  }
}
